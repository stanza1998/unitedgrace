                            ...
                            <li className="uk-width-7-8">
                                <div className="uk-panel container">
                                    ...
                                    <div className="uk-position-center uk-text-center text-overlay">
                                        <h2 data-uk-slider-parallax="x: 100,-100 " style={{ color: "white" }}>WELCOME TO TRINITY</h2>
                                    </div>
                                </div>
                            </li>
                        </ul>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body">
                                        ...
                                        <p> <strong>Artist Name: </strong> {d.artist}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                        {events.map((d) => d).length == 0 && <h5 style={{ color: "red" }}>No music added</h5>}
                    </div>
                </>}
